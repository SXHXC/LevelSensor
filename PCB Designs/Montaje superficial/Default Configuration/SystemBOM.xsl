      ...
      <BODY>
        <TABLE style="font:8pt Segoe UI" border="1" CELLSPACING="0" CELLPADDING="1" BGCOLOR="#FFFFFF">
          ...
          <TR valign="top">
            ...
            <TD align="left">
              <xsl:value-of select="@DATASHEETURL"/>
              <xsl:if test="@DATASHEETURL[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              ...
              <xsl:if test="@FAMILY_NAME[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@GENERIC_PART_NUMBER"/>
              <xsl:if test="@GENERIC_PART_NUMBER[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@INDUSTRY_STD_PKG_TYPE"/>
              <xsl:if test="@INDUSTRY_STD_PKG_TYPE[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@PACKAGE_DESIGNATOR"/>
              <xsl:if test="@PACKAGE_DESIGNATOR[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
